...
parser = argparse.ArgumentParser(description='ULN')
...
parser.add_argument("--checkpoint", type=str, default='checkpoint_x4/',
...
model = ULN(upscale_factor=opt.upscale_factor)
